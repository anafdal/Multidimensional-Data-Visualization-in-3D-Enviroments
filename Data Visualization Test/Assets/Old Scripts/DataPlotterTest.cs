...
public class DataPlotterTest : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (var j = 1; j < columnList1.Count; j++)//through columns for dates
        {
            ...
            for (var i = 0; i < dataList1.Count; i++)//go through row for states
            {
                ...
                dataPoint.GetComponent<Renderer>().material.color = Color.Lerp(Color.red, Color.blue, Mathf.PingPong(j*0.1f, 1));
